Public Partial Class MainForm
	...
	Sub Button5Click(sender As Object, e As EventArgs)
		Dim a As String
		Clipboard.Clear()
		a = System.Convert.ToString(textBox2)
		a = Replace(a, "System.Windows.Forms.TextBox, Text: ", "")
		Clipboard.SetText(a)
	End Sub
	
	Sub MainFormLoad(sender As Object, e As EventArgs)
		toolTip1.SetToolTip(button5, "Копировать")
		toolTip1.SetToolTip(button6, "Копировать")
		toolTip1.SetToolTip(button7, "Копировать")
		toolTip1.SetToolTip(button9, "Копировать")
		toolTip1.SetToolTip(button8, "Копировать")
		toolTip1.SetToolTip(button10, "Копировать")	
	End Sub
	
	Sub Button6Click(sender As Object, e As EventArgs)
		Dim a As String
		Clipboard.Clear()
		a = System.Convert.ToString(textBox3)
		a = Replace(a, "System.Windows.Forms.TextBox, Text: ", "")
		Clipboard.SetText(a)	
	End Sub
	...
	Sub Button7Click(sender As Object, e As EventArgs)
		Dim a As String
		Clipboard.Clear()
		a = System.Convert.ToString(textBox4)
		a = Replace(a, "System.Windows.Forms.TextBox, Text: ", "")
		Clipboard.SetText(a)
	End Sub
	...
	Sub Button9Click(sender As Object, e As EventArgs)
		Dim a As String
		Clipboard.Clear()
		a = System.Convert.ToString(textBox6)
		a = Replace(a, "System.Windows.Forms.TextBox, Text: ", "")
		Clipboard.SetText(a)		
	End Sub
	...
	Sub Button8Click(sender As Object, e As EventArgs)
		Dim a As String
		Clipboard.Clear()
		a = System.Convert.ToString(textBox11)
		a = Replace(a, "System.Windows.Forms.TextBox, Text: ", "")
		Clipboard.SetText(a)			
	End Sub
	...
	Sub Button10Click(sender As Object, e As EventArgs)
		Dim a As String
		Clipboard.Clear()
		a = System.Convert.ToString(textBox14)
		a = Replace(a, "System.Windows.Forms.TextBox, Text: ", "")
		Clipboard.SetText(a)			
	End Sub
End Class
